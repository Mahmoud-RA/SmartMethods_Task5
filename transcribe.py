...
authenticator = IAMAuthenticator('wHPfYOHnhXCUcKsIDU2puZpjejmYi5MUs__u_8fMwvqm')
assistant = AssistantV2(
    version='2020-04-01',
    authenticator = authenticator
)

assistant.set_service_url('https://api.eu-gb.assistant.watson.cloud.ibm.com/instances/6e0bdba8-35a0-4aeb-8716-b0d472cfbffc')
...
def main():
    ...
    assistant_id='f78a3df6-bb95-4a42-8df1-4516c698c8dc',
    input={
        'message_type': 'text',
        'text': txt
    }
    ...
    y = json.loads(z)
    respon = json.dumps(y["output"]["generic"][1]["text"]).strip('"')
